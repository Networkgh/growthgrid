...
<div class="navbar">
    ...
    <ul id="nav-menu">
        ...
        <li><a href="affdash.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
        <li><a href="marketplace.php"><i class="fas fa-store"></i> Market</a></li>
        <li><a href="recentsales.php"><i class="fas fa-chart-line"></i> Sales</a></li>

...
$query = "UPDATE vendors SET payment_method=?, bank_country=?, bank_name=?, account_number=?, account_name=? WHERE vendor_username=?";
$stmt = $db->prepare($query);
$stmt->bind_param('ssssss', $payment_method, $bank_country, $bank_name, $account_number, $account_name, $vendor_username);

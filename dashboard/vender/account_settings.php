...
$query = "SELECT vendor_username, firstname, lastname, email, phone_number, country_of_residence, payment_method,bank_country, bank_name,account_number, account_name  FROM vendors WHERE vendor_username=?";
...
<body>
    ...
    <div class="popup-form1" id="popupForm1">
        ...
        <option value="">Select Payment Method</option>
            ...
            <select id="bank_name" name="bank_name" class="hidden"  value="<?php echo htmlspecialchars($bank_name); ?>" required>

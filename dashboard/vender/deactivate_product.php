...
if (isset($_GET['id'])) {
    ...
    // SQL query to update the product status to 'deactivate'
    $update_sql = "UPDATE products SET status = 'deactivated' WHERE product_id = ?";
    ...
    if (mysqli_stmt_execute($update_stmt)) {
        ...
        $_SESSION['success'] = "Product has been successfully deactivated.";
        header('Location: my-products.php');
        exit();
    } else {
        echo "Error deactivating product: " . mysqli_error($db);
    }

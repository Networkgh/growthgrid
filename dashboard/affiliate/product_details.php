...
if (isset($_GET['product_id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        if (isset($_SESSION['affiliate_username']) && !empty($_SESSION['affiliate_username'])) {
            $affiliate_username = $_SESSION['affiliate_username']; // Use the logged-in user's username
        } else {
        ...
        $affiliate_link = "https://www.example.com/product.php?product_id=" . urlencode($product_id) . "&ref=" . urlencode($affiliate_username);
    } else {
...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .btn {
                max-width: 100%; /* Buttons take the full width on small screens */
            }
        }
...
<body>
    <div class="container">
        ...
        <div class="product-details-container">
            ...
            <a href="<?php echo htmlspecialchars($product['sale_page_url']); ?>" class="btn">View Sales Page</a>
            <a href="<?php echo htmlspecialchars($product['resources_page_url']); ?>" class="btn">Access Resources Page</a>
        </div>
    </div>

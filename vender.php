...
.cta-button:hover {
    background-color: #004080; /* Darker blue for hover */
}
...
<body>
    <div class="container-split">
        ...
        <div class="right-section">
            <div class="form-container">
                <h2>Create Account As Vendor</h2>
                <p>Already have an account? <a href="loginven.php">Sign In</a></p>
    ...
    <section id="registration-form">
        ...
        <div class="form-group">
            ...
            <span style="color: red;"><?php echo $vendor_username_error; ?></span><br>
        </div>
        ...
        <p>Do you want to promote others' peoples' products? <a href="register.php">Click here</a></p>
        <p>Before creating an account make sure you agree to our <a href="terms_conditions.php">Terms & Conditions</a></p>

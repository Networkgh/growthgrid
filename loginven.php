...
// Initialize errors array more robustly
$errors = [];
if (isset($_SESSION['register_error']) && is_array($_SESSION['register_error'])) {
    $errors = $_SESSION['register_error'];
    unset($_SESSION['register_error']); // Clear errors after displaying
}
?>
